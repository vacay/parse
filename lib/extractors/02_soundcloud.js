...
//TODO - retreive dynamicaly
var CONSUMER_ID = '02gUJC0hH2ct1EGOcYXQIzRFU91c72Ea';

var streamUrl = function(url) {
    return new URI(url).query(function(data) {
	data.client_id = 'f43e91eac578ff68472afa2172d987d3';
    }).toString();
};

var soundcloudRequest = function(url, done) {
    var apiUrl = 'http://api.soundcloud.com/resolve.json?url=' + url + '&client_id=' + CONSUMER_ID;
    request({
	url: apiUrl,
	json: true,
	maxAttempts: 2,
