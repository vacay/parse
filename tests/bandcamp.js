...
describe('Analyzing http://youtube-dl.bandcamp.com/track/youtube-dl-test-song', function () {
  ...
  it('permalink should be http://youtube-dl.bandcamp.com/track/youtube-dl-test-song', function() {
    items[0].permalink.should.equal('http://youtube-dl.bandcamp.com/track/youtube-dl-test-song');
  });
