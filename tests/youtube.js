...
describe('Analyzing http://www.youtube.com/watch?v=iODdvJGpfIA', function () {
    ...
    it('url should be https://www.youtube.com/watch?v=iODdvJGpfIA', function() {
	items[0].url.should.equal('https://www.youtube.com/watch?v=iODdvJGpfIA');
    });
...
describe('Analyzing https://www.youtube.com/playlist?list=UUXw-G3eDE9trcvY2sBMM_aA', function () {
    ...
    it('url should be https://www.youtube.com/watch?v=20jY_d5-Evc', function() {
	items[0].url.should.equal('https://www.youtube.com/watch?v=20jY_d5-Evc');
    });
