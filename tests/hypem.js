...
describe('Analyzing http://hypem.com/track/22ejp/TOURIST+-+I+Can\'t+Keep+Up+(feat.+Will+Heard)', function () {
  ...
  it('permalink should be http://hypem.com/track/22ejp/TOURIST+-+I+Can\'t+Keep+Up+(feat.+Will+Heard)', function() {
    items[0].permalink.should.equal('http://hypem.com/track/22ejp/TOURIST+-+I+Can\'t+Keep+Up+(feat.+Will+Heard)');
  });
